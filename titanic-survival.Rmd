...
*Question 4*: For those who traveled alone with no companions (spouse, sibling, parent, children) on the vessel, is their survival probability greater or less? On one hand, they are more likely to be in shortage of psychological and physical support. On the other hand, they would may be able to reach a life-saving decision faster without transaction cost and negotiation.  
...
A closer look at numbers may suggest another story. We observe that first class passengers have the highest predicted survival possibility in general, whereas the third class is the lowest. The chasm between classes is most manifest in middle-aged women. A 30-year-old first class women is likely to survive with a probability between (`label_percent(0.1)(Predict(f2, age = 30, class = "1st", gender = "Female", fun = plogis)$lower)`, `Predict(f2, age = 30, class = "1st", gender = "Female", fun = plogis)$upper`), and if she were in the third class, (`label_percent(0.1)(Predict(f2, age = 30, class = "3rd", gender = "Female", fun = plogis)$lower)`, `Predict(f2, age = 30, class = "3rd", gender = "Female", fun = plogis)$upper`). 
