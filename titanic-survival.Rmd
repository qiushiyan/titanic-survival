...
- `age` has a nice distribution with 80% observations falling between 14 and 50. Yet it is the only variable suffering from missing values after excluding irrelevant columns. 

- Both `sibsp` and `parch`
